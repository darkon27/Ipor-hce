...
{
    public class MiscDetalleRepository : GenericDataRepository<MA_MiscelaneosDetalle>, IMiscDetalleRepository 
    {
        public List<MA_MiscelaneosDetalle> getListadoRecursos(MA_MiscelaneosDetalle ObjTrace)
        {
