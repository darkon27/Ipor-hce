...
{
    public partial class rptViewMedicamentos_Epi2_FE_Edit
    {
        ...
        public int INDICADORTI { get; set; }
        public int IdPadreNutriente { get; set; }
        public int IdHijoNutriente { get; set; }
