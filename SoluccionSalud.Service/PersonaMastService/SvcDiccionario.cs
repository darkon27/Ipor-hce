...
namespace SoluccionSalud.Service.PersonaMastService
{
    ...
    public class SvcPersonaMast
    {
        ...
        public static List<PERSONAMAST> listarPersonaMast(PERSONAMAST objSC, int inicio, int final)
        {
            return new PersonaMastBLL().listarPersonaMast(objSC, inicio, final);
        }

        public static int setMantenimiento(PERSONAMAST ObjTrace)
        {
            return new PersonaMastBLL().setMantenimiento(ObjTrace);
        }
        public static int setMantenimiento(List<PERSONAMAST> listaObjSC)
        {
            return new PersonaMastBLL().setMantenimiento(listaObjSC);
        }
    }
}
