...
namespace SoluccionSalud.Service.FormulariosService
{
    public class SvcFormularios
    {
        ...
        public static Int32 setMantenimiento(SS_HC_Anamnesis_EA ObjTraces, List<SS_HC_Anamnesis_EA> Cabecera, List<SS_HC_Anamnesis_EA> Detalle)
        {
            return new AnamnesisEABLL().setMantenimiento(ObjTraces, Cabecera, Detalle);
        }        
