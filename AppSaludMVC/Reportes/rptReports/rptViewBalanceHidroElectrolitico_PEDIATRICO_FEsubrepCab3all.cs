...
namespace AppSaludMVC.Reportes.rptReports {
    ...
    public class rptViewBalanceHidroElectrolitico_PEDIATRICO_FEsubrepCab3all : ReportClass {
        
        public rptViewBalanceHidroElectrolitico_PEDIATRICO_FEsubrepCab3all() {
        }
        
        public override string ResourceName {
            get {
                return "rptViewBalanceHidroElectrolitico_PEDIATRICO_FEsubrepCab3all.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "AppSaludMVC.Reportes.rptReports.rptViewBalanceHidroElectrolitico_PEDIATRICO_FEsub" +
                    "repCab3all.rpt";
            }
            set {
                // Do nothing
    ...
    public class CachedrptViewBalanceHidroElectrolitico_PEDIATRICO_FEsubrepCab3all : Component, ICachedReport {
        
        public CachedrptViewBalanceHidroElectrolitico_PEDIATRICO_FEsubrepCab3all() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptViewBalanceHidroElectrolitico_PEDIATRICO_FEsubrepCab3all rpt = new rptViewBalanceHidroElectrolitico_PEDIATRICO_FEsubrepCab3all();
            rpt.Site = this.Site;
            return rpt;
        }
