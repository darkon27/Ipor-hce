...
namespace AppSaludMVC.Reportes.rptReports {
    ...
    public class rptViewBalanceHidroElectrolitico_PEDIATRICO_FECab2subrepall : ReportClass {
        
        public rptViewBalanceHidroElectrolitico_PEDIATRICO_FECab2subrepall() {
        }
        
        public override string ResourceName {
            get {
                return "rptViewBalanceHidroElectrolitico_PEDIATRICO_FECab2subrepall.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptViewBalanceHidroElectrolitico_PEDIATRICO_FECab2subrepall : Component, ICachedReport {
        
        public CachedrptViewBalanceHidroElectrolitico_PEDIATRICO_FECab2subrepall() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptViewBalanceHidroElectrolitico_PEDIATRICO_FECab2subrepall rpt = new rptViewBalanceHidroElectrolitico_PEDIATRICO_FECab2subrepall();
            rpt.Site = this.Site;
            return rpt;
        }
