...
namespace AppSaludMVC.Controllers
{
    ...
    public class PacienteGeneralController : System.Web.Mvc.Controller
    {
        ...
        {
            Log.Information("PacienteGeneralController - Index");
            return View();
        }
        public System.Web.Mvc.ActionResult CCEP0902_View() //Paciente
        {
            Log.Information("PacienteGeneralController - CCEP0902_View");
            return View();
        }
        public PartialViewResult PanelWest(string containerId)
        {
            Log.Information("PacienteGeneralController - PanelWest");
        ...
        {
            Log.Information("PacienteGeneralController - GrillaListadoPacientes");
        ...
        {
            Log.Information("PacienteGeneralController - LoadCentral");
        ...
        {
            Log.Information("PacienteGeneralController - GrillaListadPaginas");
        ...
        {
            Log.Information("PacienteGeneralController - GetTreeViewChild");
        ...
        {
            Log.Information("PacienteGeneralController - GetSelectPaciente");
