...
{
    public class SolucitudTransfusionalFERepository
    {
        ...
        public List<SS_HC_SolucitudTransfusional_FE> listarEntidad(SS_HC_SolucitudTransfusional_FE objSC)
        {

            List<SS_HC_SolucitudTransfusional_FE> objLista = new List<SS_HC_SolucitudTransfusional_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_SolucitudTransfusional_FE> objConsultas = (from t in context.SS_HC_SolucitudTransfusional_FE
                                                                where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_SolucitudTransfusional_FE(), new SS_HC_SolucitudTransfusional_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_SolucitudTransfusional_FE");
                    objAudit.TableName = "SS_HC_SolucitudTransfusional_FE";
        ...
        public int setMantenimiento(SS_HC_SolucitudTransfusional_FE objSC, List<SS_HC_SolucitudTransfusionalDiagnostico_FE> Detalle)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (objSC != null)
                        {
                            ...
                            SS_HC_SolucitudTransfusional_FE objAnterior = null;
                            if (objSC.Accion == null) objSC.Accion = "X";
                            if ((objSC.Accion.Substring(0, 1) != "I") && (objSC.Accion.Substring(0, 1) != "N"))
                            {
                                objAnterior = (from t in context.SS_HC_SolucitudTransfusional_FE
                                               where
                                               t.UnidadReplicacion == objSC.UnidadReplicacion
                                               && t.IdPaciente == objSC.IdPaciente
                                               && t.EpisodioClinico == objSC.EpisodioClinico
                        ...
                        if (Detalle != null)
                        {
                            ...
                            var secuenciaMax = context.SS_HC_SolucitudTransfusionalDiagnostico_FE
                                    .Where(t =>
                                            t.IdPaciente == objSC.IdPaciente
                                            && t.UnidadReplicacion == objSC.UnidadReplicacion
                                            && t.EpisodioClinico == objSC.EpisodioClinico
                            ...
                            foreach (SS_HC_SolucitudTransfusionalDiagnostico_FE objDetalle in Detalle)
                            {
        ...
        public virtual String XMLString(List<SS_HC_SolucitudTransfusional_FE> obPadre, String TablaID)
        {
