...
{
    public partial class TriajeEmergenciaFERepository
    {
        ...
        public List<SS_HC_TriajeEmergencia_FE> listarEntidad(SS_HC_TriajeEmergencia_FE objSC)
        {
            List<SS_HC_TriajeEmergencia_FE> objLista = new List<SS_HC_TriajeEmergencia_FE>();
            using (var context = new ModelFormularios())
            {
                List<SS_HC_TriajeEmergencia_FE> objConsultas = (from t in context.SS_HC_TriajeEmergencia_FE
                                                             where
                                                             t.UnidadReplicacion == objSC.UnidadReplicacion
                                                             && t.IdPaciente == objSC.IdPaciente
                                                             && t.EpisodioTriaje == objSC.EpisodioTriaje
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    DataKey = new
                    {
                        ...
                        EpisodioClinico = objSC.EpisodioTriaje,
                    ...
                    objAudit = Control.AddAudita(new SS_HC_TriajeEmergencia_FE(), new SS_HC_TriajeEmergencia_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_TriajeEmergencia_FE");
                    objAudit.TableName = "SS_HC_TriajeEmergencia_FE";
        ...
        public List<SS_HC_TriajeEmergencia_FE> listarEntidadTriajeEmergencia(SS_HC_TriajeEmergencia_FE objSC)
        {
            List<SS_HC_TriajeEmergencia_FE> objLista = new List<SS_HC_TriajeEmergencia_FE>();
            using (var context = new ModelFormularios())
            {
        ...
        public int setMantenimiento(SS_HC_TriajeEmergencia_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_TriajeEmergencia_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                                                    && t.IdPaciente == objSC.IdPaciente
                                                    && t.EpisodioTriaje == objSC.EpisodioTriaje
                            ...
                            else
                            {
                                ...
                                {
                                    var secuenciaMax = context.SS_HC_TriajeEmergencia_FE
        ...
        public virtual String XMLString(List<SS_HC_TriajeEmergencia_FE> obPadre, String TablaID)
        {
