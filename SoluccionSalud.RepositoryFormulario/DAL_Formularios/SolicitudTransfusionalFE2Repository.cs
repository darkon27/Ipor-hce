...
{
    public class SolicitudTransfusionalFE2Repository
    {
        ...
        public List<SS_HC_SolicitudTransfusional_2_FE> listarEntidad(SS_HC_SolicitudTransfusional_2_FE objSC)
        {

             List<SS_HC_SolicitudTransfusional_2_FE> objLista = new List<SS_HC_SolicitudTransfusional_2_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_SolicitudTransfusional_2_FE> objConsultas = (from t in context.SS_HC_SolicitudTransfusional_2_FE
                                                                where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_SolicitudTransfusional_2_FE(), new SS_HC_SolicitudTransfusional_2_FE(), DataKey, objAudit.Type);
                    String xlmIn = XmlString(objLista, "SS_HC_SolicitudTransfusional_2_FE");  
                    objAudit.TableName = "SS_HC_SolicitudTransfusional_2_FE";
        ...
        private string XmlString(List<SS_HC_SolicitudTransfusional_2_FE> obPadre, String TablaID)
        {
        ...
        public int setMantenimiento(SS_HC_SolicitudTransfusional_2_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_SolicitudTransfusional_2_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                                                    && t.IdPaciente == objSC.IdPaciente
                                                    && t.EpisodioClinico == objSC.EpisodioClinico
                            ...
                            else
                            {
                                ...
                                {
                                    //var secuenciaMax = context.SS_HC_SolicitudTransfusional_2_FE
