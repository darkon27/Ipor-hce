...
{
    public class ResumendelParto2FERepository
    {
        ...
        public List<SS_HC_RESUMEN_PARTO_FE_2> ResumenParto2Listar(SS_HC_RESUMEN_PARTO_FE_2 objSC)
        {

            List<SS_HC_RESUMEN_PARTO_FE_2> objLista = new List<SS_HC_RESUMEN_PARTO_FE_2>();
            using (var context = new ModelFormularios())
            {
                List<SS_HC_RESUMEN_PARTO_FE_2> objConsultas = (from t in context.SS_HC_RESUMEN_PARTO_FE_2
                                                               where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_RESUMEN_PARTO_FE_2(), new SS_HC_RESUMEN_PARTO_FE_2(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_RESUMEN_PARTO_FE_2");
                    objAudit.TableName = "SS_HC_RESUMEN_PARTO_FE_2";
        ...
        public int setMantenimiento(SS_HC_RESUMEN_PARTO_FE_2 objSave)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (objSave != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_RESUMEN_PARTO_FE_2
                                               .Where(t =>
        ...
        public virtual String XMLString(List<SS_HC_RESUMEN_PARTO_FE_2> obPadre, String TablaID)
        {
