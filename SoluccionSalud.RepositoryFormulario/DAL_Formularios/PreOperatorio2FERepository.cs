...
{
    public class PreOperatorio2FERepository
    {
        ...
        public List<SS_HC_Pre_Operatorio_2_FE> listarEntidad(SS_HC_Pre_Operatorio_2_FE objSC)
        {


            List<SS_HC_Pre_Operatorio_2_FE> objLista = new List<SS_HC_Pre_Operatorio_2_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_Pre_Operatorio_2_FE> objConsultas = (from t in context.SS_HC_Pre_Operatorio_2_FE
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_Pre_Operatorio_2_FE(), new SS_HC_Pre_Operatorio_2_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_Pre_Operatorio_2_FE");
                    objAudit.TableName = "SS_HC_Pre_Operatorio_2_FE";
        ...
        public int setMantenimiento(SS_HC_Pre_Operatorio_2_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_Pre_Operatorio_2_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                            ...
                            else
                            {
                                ...
                                {
                                    var secuenciaMax = context.SS_HC_Pre_Operatorio_2_FE
        ...
        public virtual String XMLString(List<SS_HC_Pre_Operatorio_2_FE> obPadre, String TablaID)
        {
