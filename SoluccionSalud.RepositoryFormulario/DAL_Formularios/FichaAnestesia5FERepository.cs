...
{
    public class FichaAnestesia5FERepository
    {
        ...
        public List<SS_HC_FichaAnestesia_5_FE> listarEntidad(SS_HC_FichaAnestesia_5_FE objSC)
        {


            List<SS_HC_FichaAnestesia_5_FE> objLista = new List<SS_HC_FichaAnestesia_5_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_FichaAnestesia_5_FE> objConsultas = (from t in context.SS_HC_FichaAnestesia_5_FE
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_FichaAnestesia_5_FE(), new SS_HC_FichaAnestesia_5_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_FichaAnestesia_5_FE");
                    objAudit.TableName = "SS_HC_FichaAnestesia_5_FE";
        ...
        public int setMantenimiento(SS_HC_FichaAnestesia_5_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_FichaAnestesia_5_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                            ...
                            else
                            {
                                ...
                                {
                                    //var secuenciaMax = context.SS_HC_FichaAnestesia_5_FE
                                    //                 .DefaultIfEmpty().Max(t => t == null ? 0 : t.IdPreOperatorio2);

                                    //objSC.IdPreOperatorio2 = secuenciaMax + 1;
        ...
        public virtual String XMLString(List<SS_HC_FichaAnestesia_5_FE> obPadre, String TablaID)
        {
