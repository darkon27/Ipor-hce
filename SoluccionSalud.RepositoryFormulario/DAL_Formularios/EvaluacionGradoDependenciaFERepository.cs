...
{
    public class EvaluacionGradoDependenciaFERepository
    {
        ...
        public List<SS_HC_Evaluacion_GradoDependencia_FE> listarEntidad(SS_HC_Evaluacion_GradoDependencia_FE objSC)
        {


            List<SS_HC_Evaluacion_GradoDependencia_FE> objLista = new List<SS_HC_Evaluacion_GradoDependencia_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_Evaluacion_GradoDependencia_FE> objConsultas = (from t in context.SS_HC_Evaluacion_GradoDependencia_FE
                                                            where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_Evaluacion_GradoDependencia_FE(), new SS_HC_Evaluacion_GradoDependencia_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_Evaluacion_GradoDependencia_FE");
                    objAudit.TableName = "SS_HC_Evaluacion_GradoDependencia_FE";
        ...
        public int setMantenimiento(SS_HC_Evaluacion_GradoDependencia_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_Evaluacion_GradoDependencia_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                                                    && t.IdPaciente == objSC.IdPaciente
                                                    && t.EpisodioClinico == objSC.EpisodioClinico
        ...
        public virtual String XMLString(List<SS_HC_Evaluacion_GradoDependencia_FE> obPadre, String TablaID)
        {
