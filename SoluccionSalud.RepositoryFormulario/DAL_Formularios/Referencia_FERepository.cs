...
{
    public class Referencia_FERepository
    {
        ...
        public List<SS_HC_Referencia_FE> listarEntidad(SS_HC_Referencia_FE objSC)
        {
            List<SS_HC_Referencia_FE> objLista = new List<SS_HC_Referencia_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_Referencia_FE> objConsultas = (from t in context.SS_HC_Referencia_FE
                                                                 where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    DataKey = new
                    {
                        ...
                        IdReferencia = objSC.IdReferencia
                    };
                    ...
                    String xlmIn = XMLString(objLista, "SS_HC_Referencia_FE");
                    ...
                    try
                    {
                        ...
                        if (Detalle.Count > 0)
                        {
                            ...
                            foreach (SS_HC_ReferenciaDetalle_FE objDetalle in Detalle)
                            {
                                ...
                                else if (objDetalle.Accion == "UPDATE") // Actualizar Detalle
                                {
        ...
        public virtual String XMLString(List<SS_HC_Referencia_FE> obPadre, String TablaID)
        {
