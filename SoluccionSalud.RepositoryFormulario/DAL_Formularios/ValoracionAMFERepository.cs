...
{
    public class ValoracionAMFERepository
    {
        ...
        public List<SS_HC_ValoracionAM_FE> listarEntidad( SS_HC_ValoracionAM_FE objSC)
        {


            List<SS_HC_ValoracionAM_FE> objLista = new List<SS_HC_ValoracionAM_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_ValoracionAM_FE> objConsultas = (from t in context.SS_HC_ValoracionAM_FE
                                                                where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_ValoracionAM_FE(), new SS_HC_ValoracionAM_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_ValoracionAM_FE");
                    objAudit.TableName = "SS_HC_ValoracionAM_FE";
        ...
        public int setMantenimiento(SS_HC_ValoracionAM_FE objSC)
        {
                    ...
                    try
                    {
                        if (objSC != null)
                        {
                          ...
                          //  SS_HC_ValoracionAM_FE objAnterior = null;
                            ...
                            {
                               objCount = context.SS_HC_ValoracionAM_FE
                                               .Where(t =>
                                                   t.UnidadReplicacion == objSC.UnidadReplicacion
                                                   && t.IdPaciente == objSC.IdPaciente
                                                   && t.EpisodioClinico == objSC.EpisodioClinico
        ...
        public virtual String XMLString(List<SS_HC_ValoracionAM_FE> obPadre, String TablaID)
        {
