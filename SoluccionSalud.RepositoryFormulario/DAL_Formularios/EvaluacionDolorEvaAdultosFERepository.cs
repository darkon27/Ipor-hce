...
{
    public class EvaluacionDolorEvaAdultosFERepository
    {
        ...
        public List<SS_HC_Evaluacion_DolorEvaAdultos_FE> listarEntidad(SS_HC_Evaluacion_DolorEvaAdultos_FE objSC)
        {
            List<SS_HC_Evaluacion_DolorEvaAdultos_FE> objLista = new List<SS_HC_Evaluacion_DolorEvaAdultos_FE>();

            using (var context = new ModelFormularios())
            {
                List<SS_HC_Evaluacion_DolorEvaAdultos_FE> objConsulta = (from t in context.SS_HC_Evaluacion_DolorEvaAdultos_FE
                                                                         where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_Evaluacion_DolorEvaAdultos_FE(), new SS_HC_Evaluacion_DolorEvaAdultos_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_Evaluacion_DolorEvaAdultos_FE");
                    objAudit.TableName = "SS_HC_Evaluacion_DolorEvaAdultos_FE";
        ...
        public int setMantenimiento(SS_HC_Evaluacion_DolorEvaAdultos_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_Evaluacion_DolorEvaAdultos_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                                                    && t.IdPaciente == objSC.IdPaciente
                                                    && t.EpisodioClinico == objSC.EpisodioClinico
        ...
        public virtual String XMLString(List<SS_HC_Evaluacion_DolorEvaAdultos_FE> obPadre, String TablaID)
        {
