...
{
    public class SeguridadCirugiaPausaFERepository
    {
        ...
        public List<SS_HC_SeguridadCirugia_Pausa_FE> listarEntidad(SS_HC_SeguridadCirugia_Pausa_FE objSC)
        {


            List<SS_HC_SeguridadCirugia_Pausa_FE> objLista = new List<SS_HC_SeguridadCirugia_Pausa_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_SeguridadCirugia_Pausa_FE> objConsultas = (from t in context.SS_HC_SeguridadCirugia_Pausa_FE
                                                                           where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_SeguridadCirugia_Pausa_FE(), new SS_HC_SeguridadCirugia_Pausa_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_SeguridadCirugia_Pausa_FE");
        ...
        public int setMantenimiento(SS_HC_SeguridadCirugia_Pausa_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_SeguridadCirugia_Pausa_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                                                    && t.IdPaciente == objSC.IdPaciente
                                                    && t.EpisodioClinico == objSC.EpisodioClinico
                            ...
                            else
                            {
                                ...
                                {
                                    objSC.IdSeguridadPausa = valor + 1;
                                    objSC.Version = "CCEPF462";
        ...
        public virtual String XMLString(List<SS_HC_SeguridadCirugia_Pausa_FE> obPadre, String TablaID)
        {
