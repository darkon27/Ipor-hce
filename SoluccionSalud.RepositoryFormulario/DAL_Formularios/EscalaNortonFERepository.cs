...
{
    public class EscalaNortonFERepository
    {
        ...
        public List<SS_HC_EscalaNorton_FE> listarEntidad(SS_HC_EscalaNorton_FE objSC)
        {
            List<SS_HC_EscalaNorton_FE> objLista = new List<SS_HC_EscalaNorton_FE>();
            using(var context = new ModelFormularios()){

                List<SS_HC_EscalaNorton_FE> objConsulta = (from t in context.SS_HC_EscalaNorton_FE
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_EscalaNorton_FE(), new SS_HC_EscalaNorton_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_EscalaNorton_FE");
                    objAudit.TableName = "SS_HC_EscalaNorton_FE";
        ...
        public int setMantenimiento(SS_HC_EscalaNorton_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_EscalaNorton_FE
                                               .Where(t =>
                            ...
                            else
                            {
                                ...
                                {
                                    var secuenciaMax = context.SS_HC_EscalaNorton_FE
                                           .DefaultIfEmpty().Max(t => t == null ? 0 : t.IdEscalaNorton);

                                    objSC.IdEscalaNorton = secuenciaMax + 1;
                                    objSC.Version = "CCEPF443";
                            ...
                            using (var contextEnty = new WEB_ERPSALUDEntities())
                            {
                                ...
                                DataKey = new
                                {
                                    ...
                                    EpisodioClinico = objSC.EpisodioClinico,
                                    IdPaciente = objSC.IdPaciente,
                                    IdSeguridad = objSC.IdEscalaNorton,
                                };
                                string tempType = objAudit.Type;
                                objAudit = Control.AddAudita(new SS_HC_EscalaNorton_FE(), new SS_HC_EscalaNorton_FE(), DataKey, objAudit.Type);
                                objAudit.TableName = "SS_HC_EscalaNorton_FE ";
        ...
        public virtual String XMLString(List<SS_HC_EscalaNorton_FE> obPadre, String TablaID)
        {
