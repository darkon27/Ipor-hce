...
{
    public class HojaRecienNacidoFERepository
    {
        ...
        public List<SS_HC_HojaRecienNacido_FE> listarEntidad(SS_HC_HojaRecienNacido_FE objSC)
        {
            List<SS_HC_HojaRecienNacido_FE> objLista = new List<SS_HC_HojaRecienNacido_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_HojaRecienNacido_FE> objConsultas = (from t in context.SS_HC_HojaRecienNacido_FE
                                                          where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    DataKey = new
                    {
                        ...
                        IdRecienNacido = objSC.IdRecienNacido
                    };
                    ...
                    objAudit = Control.AddAudita(new SS_HC_HojaRecienNacido_FE(), new SS_HC_HojaRecienNacido_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_HojaRecienNacido_FE");
                    objAudit.TableName = "SS_HC_HojaRecienNacido_FE";
        ...
        public int setMantenimiento(SS_HC_HojaRecienNacido_FE objSC, List<SS_HC_HojaRecienNacidoDetalle_FE> Detalle)
        {
            ...
            using (var context = new ModelFormularios())
            {
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (objSC != null)
                        {
                            int objCount = 0; //Incidencia
                            SS_HC_HojaRecienNacido_FE objAnterior = null;
                            if (objSC.Accion == null) objSC.Accion = "X";
                            if ((objSC.Accion.Substring(0, 1) != "I") && (objSC.Accion.Substring(0, 1) != "N"))
                            {
                                objAnterior = (from t in context.SS_HC_HojaRecienNacido_FE
                                               where
                                               t.UnidadReplicacion == objSC.UnidadReplicacion
                                               && t.IdPaciente == objSC.IdPaciente
                                               && t.EpisodioClinico == objSC.EpisodioClinico
                            ...
                            if (objAnterior != null)
                            {
                                ...
                                {
                                    objSC.Version = "CCEPF302";
                                    var idepisodio = context.SS_HC_HojaRecienNacido_FE
                        ...
                        if (Detalle != null)
                        {
                            ...
                            var secuenciaMax = context.SS_HC_HojaRecienNacidoDetalle_FE
                                    .Where(t =>
                                            t.IdPaciente == objSC.IdPaciente
                                            && t.UnidadReplicacion == objSC.UnidadReplicacion
                                            && t.EpisodioClinico == objSC.EpisodioClinico
                            ...
                            foreach (SS_HC_HojaRecienNacidoDetalle_FE objDetalle in Detalle)
                            {
                                int secuenciaAux = objDetalle.IdSecuencia;
                                if (objDetalle.Accion == "DETALLE")             // Insertar Detalle
                                {
                                    contadorDet++;
                                    objDetalle.IdSecuencia = secuenciaMax + contadorDet;
                                ...
                                else if (objDetalle.Accion == "UPDATEDETALLE") // Actualizar Detalle
                                {
                                    ...
                                    mapSecuencia.Add("" + secuenciaAux, objDetalle.IdSecuencia);
        ...
        public virtual String XMLString(List<SS_HC_HojaRecienNacido_FE> obPadre, String TablaID)
        {
