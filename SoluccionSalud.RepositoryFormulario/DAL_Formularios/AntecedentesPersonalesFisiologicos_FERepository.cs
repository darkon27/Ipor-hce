...
{
    public class AntecedentesPersonalesFisiologicos_FERepository
    {
        public List<SS_HC_AntecedentesPersonalesFisiologicos_FE> listarEntidad(SS_HC_AntecedentesPersonalesFisiologicos_FE objSC)
        {


            List<SS_HC_AntecedentesPersonalesFisiologicos_FE> objLista = new List<SS_HC_AntecedentesPersonalesFisiologicos_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_AntecedentesPersonalesFisiologicos_FE> objConsultas = (from t in context.SS_HC_AntecedentesPersonalesFisiologicos_FE
                                                                     where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                 ...
                 //   objAudit = Control.AddAudita(new SS_HC_AntecedentesPersonalesFisiologicos_FE(), new SS_HC_AntecedentesPersonalesFisiologicos_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_AntecedentesPersonalesFisiologicos_FE");
                    objAudit.TableName = "SS_HC_AntecedentesPersonalesFisiologicos_FE";
        ...
        public int setMantenimiento(SS_HC_AntecedentesPersonalesFisiologicos_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_AntecedentesPersonalesFisiologicos_FE
                                               .Where(t =>
                                                   t.UnidadReplicacion == objSC.UnidadReplicacion
                                                   && t.IdPaciente == objSC.IdPaciente
                                                   && t.EpisodioClinico == objSC.EpisodioClinico
                            ...
                            else
                            {
                                if (objSC.Accion == "NUEVO")
                                {
                                    ...
                                    var secuenciaMax = context.SS_HC_AntecedentesPersonalesFisiologicos_FE
                                           .DefaultIfEmpty().Max(t => t == null ? 0 : t.IdSecuencia);

                                    objSC.IdSecuencia = secuenciaMax + 1;
                                    objSC.Version = "CCEP00F3";
                            ...
                            using (var contextEnty = new WEB_ERPSALUDEntities())
                            {
                                ...
                                string tempType = objAudit.Type;
                            //    objAudit = Control.AddAudita(new SS_HC_ValoracionFuncionalAM_FE(), new SS_HC_ValoracionFuncionalAM_FE(), DataKey, objAudit.Type);
                                objAudit.TableName = "SS_HC_AntecedentesPersonalesFisiologicos_FE ";
        ...
        public virtual String XMLString(List<SS_HC_AntecedentesPersonalesFisiologicos_FE> obPadre, String TablaID)
        {
        ...
        public List<SS_HC_AntecedentesPersonalesFisiologicos_FE> listarEntidadTOP(SS_HC_AntecedentesPersonalesFisiologicos_FE objSC)
        {
            ...
            using (var context = new ModelFormularios())
            {
                ...
                List<SS_HC_AntecedentesPersonalesFisiologicos_FE> objConsultas = (from t in context.SS_HC_AntecedentesPersonalesFisiologicos_FE
                                                                                  ...
                                                                                  //&& t.EpisodioClinico == objSC.EpisodioClinico
                                                                                 // && t.IdEpisodioAtencion == objSC.IdEpisodioAtencion
                                                                                  orderby t.EpisodioClinico descending, t.IdEpisodioAtencion descending
