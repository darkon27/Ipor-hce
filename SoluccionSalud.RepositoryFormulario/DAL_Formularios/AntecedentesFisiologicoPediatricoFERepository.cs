...
{
    public class AntecedentesFisiologicoPediatricoFERepository
    {
        ...
        public List<SS_HC_Ant_Fisiologico_Pediatrico_FE> listarEntidad(SS_HC_Ant_Fisiologico_Pediatrico_FE objSC)
        {


            List<SS_HC_Ant_Fisiologico_Pediatrico_FE> objLista = new List<SS_HC_Ant_Fisiologico_Pediatrico_FE>();
            using (var context = new ModelFormularios())
            {

                List<SS_HC_Ant_Fisiologico_Pediatrico_FE> objConsultas = (from t in context.SS_HC_Ant_Fisiologico_Pediatrico_FE
                                                                where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_Ant_Fisiologico_Pediatrico_FE(), new SS_HC_Ant_Fisiologico_Pediatrico_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_Ant_Fisiologico_Pediatrico_FE");
                    objAudit.TableName = "SS_HC_Ant_Fisiologico_Pediatrico_FE";
        ...
        public int setMantenimiento(SS_HC_Ant_Fisiologico_Pediatrico_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            //  SS_HC_ValoracionAM_FE objAnterior = null;
                            if (objSC.Accion == null) objSC.Accion = "X";
                            if ((objSC.Accion.Substring(0, 1) != "I") && (objSC.Accion.Substring(0, 1) != "N"))
                            {
                                 objCount = context.SS_HC_Ant_Fisiologico_Pediatrico_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                                                    && t.IdPaciente == objSC.IdPaciente
                                                    && t.EpisodioClinico == objSC.EpisodioClinico
                            ...
                            else
                            {
                                ...
                                {
                                    var secuenciaMax = context.SS_HC_Ant_Fisiologico_Pediatrico_FE
                                           .DefaultIfEmpty().Max(t => t == null ? 0 : t.IdAntFiPediatrico);

                                    objSC.IdAntFiPediatrico = secuenciaMax + 1;
                                    objSC.Version = "CCEPF004";
                            ...
                            using (var contextEnty = new WEB_ERPSALUDEntities())
                            {
                                ...
                                DataKey = new
                                {
                                    ...
                                    EpisodioClinico = objSC.EpisodioClinico,
                                    IdPaciente = objSC.IdPaciente,
                                    IdSeguridad = objSC.IdAntFiPediatrico,
                                };
                                string tempType = objAudit.Type;
                                objAudit = Control.AddAudita(new SS_HC_Ant_Fisiologico_Pediatrico_FE(), new SS_HC_Ant_Fisiologico_Pediatrico_FE(), DataKey, objAudit.Type);
                                objAudit.TableName = "SS_HC_Ant_Fisiologico_Pediatrico_FE ";
        ...
        public virtual String XMLString(List<SS_HC_Ant_Fisiologico_Pediatrico_FE> obPadre, String TablaID)
        {
        ...
        public List<SS_HC_Ant_Fisiologico_Pediatrico_FE> listarEntidadTOP(SS_HC_Ant_Fisiologico_Pediatrico_FE objSC)
        {
