...
{
   public  class Anestesia_3_FERepository
    {
        ...
        public List<SS_HC_FichaAnestesia_3_FE> listarEntidad(SS_HC_FichaAnestesia_3_FE objSC)
        {
            List<SS_HC_FichaAnestesia_3_FE> objLista = new List<SS_HC_FichaAnestesia_3_FE>();
            using (var context = new ModelFormularios())
            {
                List<SS_HC_FichaAnestesia_3_FE> objConsultas = (from t in context.SS_HC_FichaAnestesia_3_FE
                                                                where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_FichaAnestesia_3_FE(), new SS_HC_FichaAnestesia_3_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_FichaAnestesia_3_FE");
                    objAudit.TableName = "SS_HC_FichaAnestesia_3_FE";
       ...
       public int setMantenimiento(SS_HC_FichaAnestesia_3_FE objSC)
       {
               ...
               using (var dbContextTransaction = context.Database.BeginTransaction())
               {
                   try
                   {
                       if (objSC != null)
                       {
                           ...
                           {
                               objCount = context.SS_HC_FichaAnestesia_3_FE
                                               .Where(t =>
                                                   t.UnidadReplicacion == objSC.UnidadReplicacion
                                                   && t.IdPaciente == objSC.IdPaciente
                                                   && t.EpisodioClinico == objSC.EpisodioClinico
                           ...
                           //valor = context.SS_HC_FichaAnestesia_3_FE.Count();
                           /**TRANSACCIÓN*/
                           if (objCount > 0)
                           {
                               if (objSC.Accion == "UPDATE")
                               {
                                   objSC.Version = "CCEPF323_3";
                           ...
                           else
                           {
                               ...
                               {
                                  // var secuenciaMax = context.SS_HC_FichaAnestesia_3_FE
       ...
       public virtual String XMLString(List<SS_HC_FichaAnestesia_3_FE> obPadre, String TablaID)
       {
