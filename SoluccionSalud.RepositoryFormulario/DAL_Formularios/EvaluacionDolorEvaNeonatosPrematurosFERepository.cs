...
{
    public class EvaluacionDolorEvaNeonatosPrematurosFERepository
    {
        ...
        public List<SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE> listarEntidad(SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE objSC)
        {
            List<SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE> objLista = new List<SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE>();

            using (var context = new ModelFormularios())
            {
                List<SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE> objConsulta = (from t in context.SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE
                                                                         where
                ...
                using (var contextEnty = new WEB_ERPSALUDEntities())
                {
                    ...
                    objAudit = Control.AddAudita(new SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE(), new SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE(), DataKey, objAudit.Type);
                    String xlmIn = XMLString(objLista, "SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE");
                    objAudit.TableName = "SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE";
        ...
        public int setMantenimiento(SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE objSC)
        {
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        if (objSC != null)
                        {
                            ...
                            {
                                objCount = context.SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE
                                                .Where(t =>
                                                    t.UnidadReplicacion == objSC.UnidadReplicacion
                                                    && t.IdPaciente == objSC.IdPaciente
                                                    && t.EpisodioClinico == objSC.EpisodioClinico
        ...
        public virtual String XMLString(List<SS_HC_Evaluacion_DolorEvaNeonatosPrematuros_FE> obPadre, String TablaID)
        {
