...
{
    public class BalanceHidroelectroNEOFERepository
    {
        public List<SS_HC_BalanceHidroElectNeo_FE> Lista_Cabecera(SS_HC_BalanceHidroElectNeo_FE ObjSC)
        {

            List<SS_HC_BalanceHidroElectNeo_FE> objCabecera = null;
            using (var context = new ModelFormularios())
            {

                objCabecera = context.SP_SS_HC_BalanceHidroElectNeo_FE_Listar(
        ...
        public List<SS_HC_SolucionesAdministradas_FE> Listar_Soluciones(SS_HC_SolucionesAdministradas_FE obj)
        {

            List<SS_HC_SolucionesAdministradas_FE> objExamen = null;

            using (var context = new ModelFormularios())
            {

                objExamen = context.SP_SS_HC_SolucionesAdministradas_FE_Listar(
        ...
        public int setMantenimiento(SS_HC_BalanceHidroElectNeo_FE objSC, List<SS_HC_SolucionesAdministradas_FE> detalle1)
        {
            ...
            using (var context = new ModelFormularios())
            {
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if(objSC !=null){
                            iReturnValue = context.SP_SS_HC_BalanceHidroElectNeo_FE(
                        ...
                        if (detalle1 != null)
                        {
                            foreach (var ObjTrace in detalle1)
                            {
                                ...
                                iReturnValue = context.SP_SS_HC_SolucionesAdministradas_FE(
