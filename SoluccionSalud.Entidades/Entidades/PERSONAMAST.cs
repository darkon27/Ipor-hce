...
namespace SoluccionSalud.Entidades.Entidades
{
    public partial class PERSONAMAST
    {
        public PERSONAMAST()
        {
            this.EMPLEADOMASTs = new HashSet<EMPLEADOMAST>();
            this.SS_HC_EstablecimientoSalud = new HashSet<SS_HC_EstablecimientoSalud>();
        ...
        public string DireccionAmbiental { get; set; }
        ...
        public virtual ICollection<EMPLEADOMAST> EMPLEADOMASTs { get; set; }
        public virtual ICollection<SS_HC_EstablecimientoSalud> SS_HC_EstablecimientoSalud { get; set; }
