...
{
    public partial class rptViewEscalaWoodDownes_FE
    {
        public string UnidadReplicacion { get; set; }
        public long IdEpisodioAtencion { get; set; }
        public int IdPaciente { get; set; }
        public int EpisodioClinico { get; set; }
        public int IdEscalaWoodDownes { get; set; }
        public Nullable<System.DateTime> Fecha { get; set; }
        public Nullable<System.DateTime> Hora { get; set; }
        public string Turno { get; set; }
        public Nullable<int> Sibilancias { get; set; }
        public Nullable<int> Tiraje { get; set; }
        public Nullable<int> FrecuenciaResp { get; set; }
        public Nullable<int> FrecuenciaCard { get; set; }
        public Nullable<int> EntradaAire { get; set; }
        public Nullable<int> Cianosis { get; set; }
