...
namespace SoluccionSalud.Entidades.Entidades
{
    public partial class SS_HC_EpisodioAtencion
    {
        ...
        public string NombrePacienteTriaje { get; set; }
        ...
        public string flag_valor_concatenado { get; set; }

        public bool flagAnamnesis { get; set; }
        public bool flagDiagnostico { get; set; }
        public bool flagReceta { get; set; }
        public bool flagPlanTrabajo { get; set; }

        
        public int flagAnamnesisCount { get; set; }
        public int flagDiagnosticoCount { get; set; }
        public int flagRecetaCount { get; set; }
        public int flagPlanTrabajoCount { get; set; }

        public string flagFormato { get; set; }

        public string LineaHospitalizacionflag { get; set; }
